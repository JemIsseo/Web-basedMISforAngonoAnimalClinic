...
include 'connect.php';
$pid = $_GET['petid'];
$result = mysqli_query($conn, "SELECT * FROM tblappointments WHERE status='Completed' AND petid = '$pid' ");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="fab-wrapperleft">
        <label class="fab">
            <center>
                <a href="../login-system-main/profile.php" class="print-button">Return</a>
            </center>
        </label>
    </div>
    <div class="reportPage">
        ...
        <div class="reportContainer">
            <label class="tblTitle">Pet History</label>
             <table class="tblReportData" id="tblReportData">
                ...
                <?php while ($row = $result->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td><a href="<?php echo $row['dateandtime']; ?>"><?php echo $row['dateandtime']; ?></a></td>
