        ...
        if (isset($_POST['uploadphoto']) && isset($_FILES['image'])) {
            ...
            if (in_array($img_ex_lc, $allowed_exs)) {
                ...
                if ($res) {
                    ...
                    VALUES ('" . $_SESSION['username'] . "','$ipaddress','Uploaded a photo in useraccount module')");
                            ?>
            <div class="statusmessagesuccess message-box" id="close">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <section class="tableaccountrecords">
                        <div class="accountrecordsbg">
                            <div class="accountrecords">
                                <table class="content-table table-fixed" id="restoreUserAccount">
                                    <thead>
                                        <tr>
                                            <th>Username</th>
                                            <th>Password</th>
