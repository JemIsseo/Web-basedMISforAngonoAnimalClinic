<?php
include '../connect.php';
$result = $conn->query("SELECT * FROM tbluseraccount WHERE archive = 'false'");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>USERACCOUNT REPORT</title>
</head>
<style>
    body {
...
<body>
    ...
    <div class="reportPage">
        ...
        <div class="reportContainer">
            <label class="tblTitle">Useraccount</label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="profile-photo">
                                <img style="border: 1px solid lightblue; height: 50px; width: 50px; border-radius: 10px;" src="../uploads/<?php echo $row['image']; ?>">
                            </div>
                        </td>
                    </tr>
                <?php } ?>
